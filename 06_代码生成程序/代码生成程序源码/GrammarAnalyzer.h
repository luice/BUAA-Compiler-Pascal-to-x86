...
private:
    // 单例模式
    GrammarAnalyzer(LexicalAnalyzer &, ErrorHandler &, SymbolTableManager &, SemanticAnalyzer &);
...
private:
    ...
    void expressionAnalyze(string &value, BasicType &type, bool &variable);
    void termAnalyze(string &value, BasicType &type, bool &variable);
    void factorAnalyze(string &value, BasicType &type, bool &variable);
